...
namespace Jint.Native {
    ...
    public class JsFunctionConstructor : JsConstructor {
        ...
        public JsFunction New<T>(Delegates.Func<T, JsInstance> impl) where T : JsInstance
        {
        ...
        public JsFunction New<T>(Delegates.Func<T, JsInstance> impl, int length) where T : JsInstance
        {
        ...
        public JsFunction New<T>(Delegates.Func<T, JsInstance[], JsInstance> impl) where T : JsInstance
        {
            JsFunction function = new ClrImplDefinition<T>(impl, PrototypeProperty);
            function.PrototypeProperty = Global.ObjectClass.New(function);
            //function.Scope = new JsScope(PrototypeProperty);
        ...
        public JsFunction New<T>(Delegates.Func<T, JsInstance[], JsInstance> impl, int length) where T : JsInstance
        {
            JsFunction function = new ClrImplDefinition<T>(impl, length, PrototypeProperty);
            function.PrototypeProperty = Global.ObjectClass.New(function);
            //function.Scope = new JsScope(PrototypeProperty);
